...
def main(): ## Welcome user to the program while initializing variables for later inputs
    ...
    for i in range(loop): ## Loop that creates a countdown timer 
        ...
        while t:
            ...
            pen.sety(150)
            pen.write('Work! Work! Work!',align='center', font=('Times New Roman', 25)) ##Print label for timer during each period
            pen.sety(75)
            pen.write('Time Left:', align='center', font=('Times New Roman', 25))
            pen.sety(0)
            pen.write(timer, align='center', font=('Times New Roman', 25))
            time.sleep(0.5) ## Time blinks to reveal each new second
            t-= 1  
            pen.clear()
            if t == 0:
    ...
    turtle.Terminator() 
    house()
    pen.write('Look, I made this while you were busy.',align='center', font=('Times New Roman', 25))
    time.sleep(5) 
